    ...
    <section>
      ...
      <div className="mt-4 flex flex-col gap-4">
        <div className="p-4 border rounded-lg">
          ...
          <ChipList className="mt-2" items={[Tech.REACT_JS, Tech.NODE_JS, Tech.TENSORFLOW]} />
        </div>
        <div className="p-4 border rounded-lg">
          ...
          <ChipList className="mt-2" items={[Tech.REACT_JS, Tech.NODE_JS, Tech.WEB_RTC]} />
        </div>
        <div className="p-4 border rounded-lg">
          ...
          <ChipList className="mt-2" items={[Tech.REACT_JS, Tech.TAIL_WIND_CSS]} />
        </div>
        <div className="p-4 border rounded-lg">
          ...
          <ChipList className="mt-2" items={[Tech.PYTHON, Tech.FLASK, Tech.TENSORFLOW]} />
        </div>
      </div>
    </section>
  );
